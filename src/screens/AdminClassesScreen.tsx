    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          ...
          <Text style={styles.subtitle}>Crear y gestionar entrenamientos</Text>
        </View>
      </View>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.emptyState}>
          ...
          <Text style={styles.emptyText}>
            Aquí podrás crear clases puntuales, clases recurrentes, editar y cancelar entrenamientos
          </Text>
        </View>
      </ScrollView>
    </View>
